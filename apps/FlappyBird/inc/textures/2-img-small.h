#ifndef __IMG_2_SMALL_H__
#define __IMG_2_SMALL_H__

#include <stdint.h>

const uint16_t img_2_small_data[] = {
...
const struct OBMHeader img_2_small = {
    .signature = 32145,
    .width = 12,
    .height = 14,
    .pixels = img_2_small_data
};

#endif // __IMG_2_SMALL_H__
