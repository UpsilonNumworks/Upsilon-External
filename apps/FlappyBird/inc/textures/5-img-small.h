#ifndef __IMG_5_SMALL_H__
#define __IMG_5_SMALL_H__

#include <stdint.h>

const uint16_t img_5_small_data[] = {
...
const struct OBMHeader img_5_small = {
    .signature = 32145,
    .width = 12,
    .height = 14,
    .pixels = img_5_small_data
};

#endif // __IMG_5_SMALL_H__
